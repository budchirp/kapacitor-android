...
import com.cankolay.kapacitor.android.presentation.viewmodel.auth.SignInViewModel
...
fun SignInView(
    ...
    val data by signInViewModel.data.collectAsState()
    val errors by signInViewModel.errors.collectAsState()
    ...
    Column(modifier = Modifier.fillMaxSize()) {
            ...
            item {
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { text ->
                            signInViewModel.updateData(newData = data.copy(username = text))
                        },
                    )
            ...
            item {
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { text ->
                            signInViewModel.updateData(newData = data.copy(password = text))
                        },
                    )
        ...
        Column(
            ...
            Button(onClick = {
                if (signInViewModel.validateData().isEmpty()) {
                    coroutineScope.launch {
                        val result = signInViewModel.submit()
                        when (result) {
